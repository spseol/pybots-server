...
from pybots.game.fields.laser_battery_bot_field import LaserBatteryBotField
...
class FieldPlacerMixin(object, metaclass=ABCMeta):
    ...
    def place_fields(self, game_map=None, *args, **kwargs):
        bot_field_class = LaserBatteryBotField if getattr(kwargs.get('conf', None), 'battery_game', None) else BotField
