...
\begin{wrapfigure}[10]{R}{0.5\textwidth}
 \centering
 \includesvg[width=0.5\textwidth]{assets/python-logo}
...
\begin{code}[language=plain,caption={Ukázka výstupu ze spuštění testů}]
...
\begin{wrapfigure}[16]{R}{\textwidth/3}
    \centering
    \includesvg[width=\textwidth/3]{assets/flask-logo}
