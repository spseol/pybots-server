...
% support command for includesvg
...
\begin{figure}[H]
 ...
 \includesvg{images/flask-logo}
 \caption{Logo webového framevorku Flask}
\end{figure}
...
\listoffigures
\addcontentsline{toc}{section}{Seznam obrázk\r{u}}
