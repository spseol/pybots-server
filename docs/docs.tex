...
\usepackage[bookmarksopen,bookmarks,pdfauthor={Josef Kolar},pdftitle={Souboje virtualnich robotu PYBOTS},pdfsubject={herní server PYBOTS pro programátory},pdfkeywords={python,game,programmers,flask,maze,bots}]{hyperref} % odkazy
